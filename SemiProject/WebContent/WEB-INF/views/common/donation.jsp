    ...
    <div class="layout-wrap">
      ...
      <header>
        <div class="header-wrap">
          <a href="./index.html" class="home">로고</a>
          <button type="button" class="menu-btn">메뉴열기</button>
          <ul class="nav">
            <li class="nav-item"><a class="#none">메뉴1</a></li>
            <li class="nav-item"><a class="#none">메뉴2</a></li>
            <li class="nav-item"><a class="#none">메뉴3</a></li>
            <li class="nav-item"><a class="#none">메뉴4</a></li>
            <li class="nav-item"><a class="#none">메뉴5</a></li>
          </ul>
          <div class="right-col">
            <ul class="login">
            ...
            <a class="interior-link" href="#none">후원하기</a>
          </div>
        </div>

        <div class="mobile-panel">
          <div class="panel-board">
            <button type="button" class="board-close-btn"></button>
