        ...
        <div>
          <div>
            <div class="tableLogin">
              ...
              <hr>
              <div class="joinjoin">
                <div class="loginPageJoin" style="width: 160px; margin: 0 auto; height: 30px; margin-bottom: 2px; font-weight: bold;"><input type="submit" style="text-decoration: none;" value="로그인"></div>
                
                <div class="loginPageJoin" style="width: 160px; margin: 0 auto; height: 30px;"><a style="text-decoration: none;" href="/Member/join.jsp">회원가입</a></div>
