...
<body>
	...
	<div class="content">
		<div class="content-detail">
			...
			<span style="color:rgba(80, 185, 226, 0.959);"><%=search %></span><span>의 검색결과 입니다.</span><br>
			 <ul>
			 <%for(Product p : list){ %>
			 <li>
			...
			<span><i class="fa fa-heart"></i>후원상품</span>
			 ...
			 <li>
	            <h3><%=d.getDona_title() %></h3>
	            <h5><%=d.getDona_content() %></h5>
	            <h5><%=d.getDona_writer() %></h5>
	          </li>
			<%} %>
			</ul>
